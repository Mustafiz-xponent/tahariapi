...
(0, validator_1.default)(admin_dto_1.zAdminForgotPasswordDto), AdminController.adminForgotPassword);
// Route to reset password
router.post("/reset-password", (0, validator_1.default)(admin_dto_1.zAdminResetPasswordDto), AdminController.adminResetPassword);
// Route to delete an admin by superadmin
router.delete("/:id", auth_1.authMiddleware, (0, auth_1.authorizeRoles)(client_1.UserRole.SUPER_ADMIN), AdminController.deleteAdmin);
